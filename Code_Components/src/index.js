...
//For deployment, these were replaced with the information
//from the .env file to fix some errors I was getting.
//I did not want to push those credentials to GitHub.
const dbConfig = { 
...
db.connect()
  ...
  .catch(error => {
    ...
    console.error('Is the PostgreSQL server running? Is the host and port correct?');
  });
